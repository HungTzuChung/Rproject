...
```{r ans13}
a=classData$學號[(classData$`公-10-06`=="有看公告"&classData$`練2018-10-17-1`=="1")]
b=classData$學號[(classData$`公-10-06`=="有看公告")]
x=length(a)
y=length(b)
x/y
```
...
```{r ans14}
aa=classData$學號[(classData$`公-10-06`=="沒看公告"&classData$`練2018-10-17-1`=="1")]
bb=classData$學號[(classData$`公-10-06`=="沒看公告")]
xx=length(aa)
yy=length(bb)
xx/yy
```
...
```{r ans23}
as.POSIXct(hwData$deadline,tz="GMT")->hwData$deadline
as.POSIXct(hwData$Timestamp,tz="GMT")->hwData$Timestamp
hwData$early<-difftime(hwData$deadline,hwData$Timestamp,units = "days")
```
...
```{r ans25}
abc<-hwData$early[hwData$作業代碼=="hw1"]
table(abc)
```
